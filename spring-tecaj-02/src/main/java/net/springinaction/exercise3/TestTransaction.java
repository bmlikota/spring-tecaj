...
public class TestTransaction {
	...
	public static void main(String[] args) {
		...
		ApplicationContext ctx = new ClassPathXmlApplicationContext("spring-workshop-02/exercise-3/transaction-ctx.xml");
		//ApplicationContext ctx = new ClassPathXmlApplicationContext("spring-workshop-02/exercise-3/transaction-2-ctx.xml");
		
		//WeatherService service = (WeatherService) ctx.getBean("weatherService");
		WeatherService service = (WeatherService) ctx.getBean("weatherServiceTs");
